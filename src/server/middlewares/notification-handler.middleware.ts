...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'plant_data.update': {
    ...
    key: 'solar-plant-data-updated',
    tenantPath: ['organization', 'solar_plant', 'plant_data'],
    userPath: [],
  },
  'plant_data.create': {
    roles: ['owner', 'team-member'],
    key: 'solar-plant-data-created',
    tenantPath: ['organization', 'solar_plant', 'plant_data'],
    userPath: [],
  },
  'user.delete': {
...
const tenantRoles: string[] = ['owner', 'team-member', 'data-analyst', 'plant-manager'];
