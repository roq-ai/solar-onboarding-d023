...
import { getGuestViewById } from 'apiSdk/guest-views';
import { GuestViewInterface } from 'interfaces/guest-view';

function GuestViewViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('guest_view', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/guest-views/edit/${id}`} passHref legacyBehavior>
                    <Button
