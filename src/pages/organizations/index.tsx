...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'guest_view.count', 'invitation.count', 'solar_plant.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('guest_view', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'guest_view',
          header: 'Guest View',
          accessorKey: 'guest_view',
          cell: ({ row: { original: record } }: any) => record?._count?.guest_view,
        }
      : null,
    ...
    hasAccess('solar_plant', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.solar_plant,
        }
      : null,
