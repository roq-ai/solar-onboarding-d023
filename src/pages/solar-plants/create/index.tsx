...
import { createSolarPlant } from 'apiSdk/solar-plants';
...
function SolarPlantCreatePage() {
  ...
  const formik = useFormik<SolarPlantInterface>({
    initialValues: {
      commissioning_date: new Date(new Date().toDateString()),
      location: '',
      asset_size: 0,
