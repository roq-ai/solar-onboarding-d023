...
import { getSolarPlantById } from 'apiSdk/solar-plants';
import { SolarPlantInterface } from 'interfaces/solar-plant';
import { PlantDataListPage } from 'pages/plant-data';

function SolarPlantViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('solar_plant', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/solar-plants/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  ...
                  text={
                    data?.commissioning_date
                      ? format(parseISO(data?.commissioning_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem label="Asset Size" text={data?.asset_size} />
